...
export default function Orders() {
  ...
  if (loading)
    return <p className="text-center w-full h-full bg-gradient-to-br from-amber-100 via-orange-100 to-yellow-500 text-3xl py-20">Loading your orders...</p>;
  if (!orders.length)
    return <p className="text-center w-full h-full text-3xl bg-gradient-to-br from-amber-100 via-orange-100 to-yellow-500 py-20">No orders found.</p>;
