...
//                 products: cart.items.map((item) => ({
//                     productId: item.product?._id || item.productId,
//                     title: item.product?.name || "Product",   // ✅ snapshot required
//                     price: item.product?.price || 0,          // ✅ snapshot required
//                     quantity: item.quantity,
//                 })),
//                 shippingAddress: {
//                     fullName: name,
...
//                     country: "India",
//                 },
//                 paymentMethod: "COD",     // ✅ matches backend enum
//                 totalAmount: total,       // ✅ corrected field
//             },
//             { headers: { Authorization: `Bearer ${token}` } }
//         );
